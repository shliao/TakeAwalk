        ...
        <div class="col-lg-8 col-xl-7 col-xxl-6">
            <div class="my-5 text-center text-xl-start">
                ...
                <table>
                    ...
                    <tr>
                        <td>密碼:<asp:TextBox ID="txbPassword" runat="server" TextMode="Password" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>電話:<asp:TextBox ID="txbMobilePhone" runat="server" TextMode="Phone"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
